					...
					<div class="panel panel-default" style="height: 410">
						<div class="panel-heading">
							<div class="text-muted bootstrap-admin-box-title">
								<a href="javascript:volid(0);">订单信息</a>
							</div>
						</div>
						<div class="bootstrap-admin-panel-content">
								...
								<tbody>
									<s:iterator value="#request.orderList" status="vs" var="s">
										...
										<td>
											...
											<td class="actions">
												<a href="orderupdate?order.oid=${s.oid}">
													<button class="btn btn-sm btn-primary">
														<i class="glyphicon glyphicon-pencil"></i> 出货
													</button> </a>
													<a href="adminorderTodetail?order.oid=${s.oid}">
													<button class="btn btn-sm btn-success">
														<i class="glyphicon glyphicon-pencil"></i> 查看详情
													</button> </a>
												<a href="orderdelete?order.oid=${s.oid}">
							...
							<s:if test="#request.page.hasPrePage">
								<span class="btn btn-default"><a
									href="adminorderlist?currentPage=1">首页</a> </span>
								<span class="btn btn-default"><a
									href="adminorderlist?currentPage=${page.currentPage -1 }">上一页</a> </span>
							</s:if>
							<s:else>
							...
							<s:if test="#request.page.hasNextPage">
								<span class="btn btn-default"><a
									href="adminorderlist?currentPage=${page.currentPage + 1 }">下一页</a> </span>
								<span class="btn btn-default"><a
									href="adminorderlist?currentPage=${page.totalPage }">尾页</a> </span>
							</s:if>
							<s:else>
