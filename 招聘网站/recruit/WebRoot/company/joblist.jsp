		...
		<jsp:include page="left.jsp" />
				...
				<div class="panel panel-default" >
                                    ...
                                    <table class="table bootstrap-admin-table-with-actions">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width: 35">需求人数 </th>
                                                <th >要求</th>
                                                <th style="width: 35">工作地址</th>
                                                <th style="width: 35">薪资</th>
                                                <th style="width: 35">发布/修改日期</th>
                                                <th>操作</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>${s.address}</td>
                                                 <td>${s.salary}</td>
                                                  <td>${s.sendtime}</td>
                                                <td class="actions">
                                                    <a href="jobToUpdate?job.id=${s.id}">
							...
							<s:if test="#request.page.hasPrePage">
								<span class="btn btn-default"><a href="joblist?currentPage=1">首页</a>
								</span>
								<span class="btn btn-default"><a
									href="joblist?currentPage=${page.currentPage -1 }">上一页</a>
								</span>
							</s:if>
							<s:else>
							...
							<s:if test="#request.page.hasNextPage">
								<span class="btn btn-default"><a
									href="joblist?currentPage=${page.currentPage + 1 }">下一页</a>
								</span>
								<span class="btn btn-default"><a
									href="joblist?currentPage=${page.totalPage }">尾页</a>
								</span>
							</s:if>
							<s:else>
