				...
				<div class="col-lg-12">
					<div class="panel panel-default" style="height: 410">
						<div class="panel-heading">
							...
							<a href="admin/newsadd.jsp">新增新闻信息</a>
							</div>
						</div>
						<div class="bootstrap-admin-panel-content">
								...
								<tbody>
									<s:iterator value="#request.newsList" status="vs" var="s">
										<tr>
											...
											<td class="actions">
												<a href="anewsToUpdate?news.nid=${s.nid}">
													<button class="btn btn-sm btn-primary">
														<i class="glyphicon glyphicon-pencil"></i>查看
													</button> </a>
												<a href="newsdelete?news.nid=${s.nid}">
							...
							<s:if test="#request.page.hasPrePage">
								<span class="btn btn-default"><a
									href="adminnewslist?currentPage=1">首页</a> </span>
								<span class="btn btn-default"><a
									href="adminnewslist?currentPage=${page.currentPage -1 }">上一页</a> </span>
							</s:if>
							<s:else>
							...
							<s:if test="#request.page.hasNextPage">
								<span class="btn btn-default"><a
									href="adminnewslist?currentPage=${page.currentPage + 1 }">下一页</a> </span>
								<span class="btn btn-default"><a
									href="adminnewslist?currentPage=${page.totalPage }">尾页</a> </span>
							</s:if>
							<s:else>
