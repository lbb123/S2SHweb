					...
					<div class="panel panel-default" style="height: 410">
						<div class="panel-heading">
							<div class="text-muted bootstrap-admin-box-title">
								<a href="admin/addadmin.jsp">新增管理员</a>
							</div>
						</div>
						<div class="bootstrap-admin-panel-content">
							<table class="table bootstrap-admin-table-with-actions">
								...
								<tbody>
									<s:iterator value="#request.adminList" status="vs" var="s">
										<tr>
											<td>
												${s.id}
											</td>
										...
										<s:if test="#session.admin.id==1">
										<td>
												${s.password}
											</td>	
											<td class="actions">
												<a href="adminToUpdate?admin.id=${s.id}">
													<button class="btn btn-sm btn-primary">
														<i class="glyphicon glyphicon-pencil"></i> 修改
													</button> </a>
												<a href="admindelete?admin.id=${s.id}">
											...
											<s:else>
											<td>
												<span class="btn btn-default">无权限</span>
											</td>	
											<td>
												<span class="btn btn-default">无权限</span>
											</td>
							...
							<s:if test="#request.page.hasPrePage">
								<span class="btn btn-default"><a
									href="adminlist?currentPage=1">首页</a> </span>
								<span class="btn btn-default"><a
									href="adminlist?currentPage=${page.currentPage -1 }">上一页</a> </span>
							</s:if>
							<s:else>
							...
							<s:if test="#request.page.hasNextPage">
								<span class="btn btn-default"><a
									href="adminlist?currentPage=${page.currentPage + 1 }">下一页</a> </span>
								<span class="btn btn-default"><a
									href="adminlist?currentPage=${page.totalPage }">尾页</a> </span>
							</s:if>
							<s:else>
