						...
						<div class="bootstrap-admin-panel-content">
								...
								<tbody>
									<s:iterator value="#request.discussList" status="vs" var="s">
										<tr>
											...
											<td class="actions">
												<a href="discussdelete?discuss.id=${s.id}">
							...
							<s:if test="#request.page.hasPrePage">
								<span class="btn btn-default"><a
									href="discusslist?currentPage=1">首页</a> </span>
								<span class="btn btn-default"><a
									href="discusslist?currentPage=${page.currentPage -1 }">上一页</a> </span>
							</s:if>
							<s:else>
							...
							<s:if test="#request.page.hasNextPage">
								<span class="btn btn-default"><a
									href="discusslist?currentPage=${page.currentPage + 1 }">下一页</a> </span>
								<span class="btn btn-default"><a
									href="discusslist?currentPage=${page.totalPage }">尾页</a> </span>
							</s:if>
							<s:else>
