		...
		<jsp:include page="left.jsp" />
				...
				<div class="panel panel-default" style="height: 500">
                                    ...
                                    <table class="table bootstrap-admin-table-with-actions">
                                        ...
                                        <s:iterator value="#request.resumeList" status="vs" var="s">
                                            <tr>
                                                ...
                                                <td>${s.phone}</td>
                                                <td class="actions">
                                                    <a href="resumeToUpdate?resume.id=${s.id}">
                                                        <button class="btn btn-sm btn-primary">
                                                            <i class="glyphicon glyphicon-pencil"></i>
                                                            修改
                                                        </button>
                                                    </a>
                                                    <a href="resumedetail?resume.id=${s.id}">
                                                    ...
                                                    <a href="resumedelete?resume.id=${s.id}">
							...
							<s:if test="#request.page.hasPrePage">
								<span class="btn btn-default"><a href="resumelist?currentPage=1">首页</a>
								</span>
								<span class="btn btn-default"><a
									href="resumelist?currentPage=${page.currentPage -1 }">上一页</a>
								</span>
							</s:if>
							<s:else>
							...
							<s:if test="#request.page.hasNextPage">
								<span class="btn btn-default"><a
									href="resumelist?currentPage=${page.currentPage + 1 }">下一页</a>
								</span>
								<span class="btn btn-default"><a
									href="resumelist?currentPage=${page.totalPage }">尾页</a>
								</span>
							</s:if>
							<s:else>
