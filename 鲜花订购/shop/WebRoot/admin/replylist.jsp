					...
					<div class="panel panel-default" style="height: 410">
						<div class="panel-heading">
							<div class="text-muted bootstrap-admin-box-title">
								<a href="javascript:volid(0);">回复信息</a>
							</div>
						</div>
						<table
					...
					<br>
							...
							<s:if test="#request.page.hasPrePage">
								<span class="btn btn-default"><a
									href="adminreplylist?currentPage=1&message.mid=${mid}">首页</a> </span>
								<span class="btn btn-default"><a
									href="adminreplylist?currentPage=${page.currentPage -1 }&message.mid=${mid}">上一页</a> </span>
							</s:if>
							<s:else>
							...
							<s:if test="#request.page.hasNextPage">
								<span class="btn btn-default"><a
									href="adminreplylist?currentPage=${page.currentPage + 1 }&message.mid=${mid}">下一页</a> </span>
								<span class="btn btn-default"><a
									href="adminreplylist?currentPage=${page.totalPage }&message.mid=${mid}">尾页</a> </span>
							</s:if>
							<s:else>
