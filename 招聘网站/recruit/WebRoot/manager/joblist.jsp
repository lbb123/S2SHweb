		...
		<jsp:include page="left.jsp" />
				...
				<div class="panel panel-default" >
							...
							<s:if test="#request.page.hasPrePage">
								<span class="btn btn-default"><a href="mjoblist?currentPage=1">首页</a>
								</span>
								<span class="btn btn-default"><a
									href="mjoblist?currentPage=${page.currentPage -1 }">上一页</a>
								</span>
							</s:if>
							<s:else>
							...
							<s:if test="#request.page.hasNextPage">
								<span class="btn btn-default"><a
									href="mjoblist?currentPage=${page.currentPage + 1 }">下一页</a>
								</span>
								<span class="btn btn-default"><a
									href="mjoblist?currentPage=${page.totalPage }">尾页</a>
								</span>
							</s:if>
							<s:else>
