					...
					<div class="panel panel-default" style="height: 410">
						<div class="panel-heading">
							<div class="text-muted bootstrap-admin-box-title">
								<a href="admin/catelogadd.jsp">新增分类</a>
							</div>
						</div>
						<div class="bootstrap-admin-panel-content">
									...
									<s:iterator value="#request.catelogList" status="vs" var="s">
										...
										<td>
											...
											<td class="actions">
												...
												<a href="catelogdelete?catelog.cid=${s.cid}">
							...
							<s:if test="#request.page.hasPrePage">
								<span class="btn btn-default"><a
									href="cateloglist?currentPage=1">首页</a> </span>
								<span class="btn btn-default"><a
									href="cateloglist?currentPage=${page.currentPage -1 }">上一页</a> </span>
							</s:if>
							<s:else>
							...
							<s:if test="#request.page.hasNextPage">
								<span class="btn btn-default"><a
									href="cateloglist?currentPage=${page.currentPage + 1 }">下一页</a> </span>
								<span class="btn btn-default"><a
									href="cateloglist?currentPage=${page.totalPage }">尾页</a> </span>
							</s:if>
							<s:else>
