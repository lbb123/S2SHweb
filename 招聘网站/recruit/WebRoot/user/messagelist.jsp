		...
		<jsp:include page="left.jsp" />
				...
				<div class="panel panel-default" style="height: 500">
                                        ...
                                        <s:iterator value="#request.messageList" status="vs" var="s">
                                            <tr>
                                                ...
                                                <td class="actions">
                                                    ...
                                                    <a href="messagedelete?message.id=${s.id}">
							...
							<s:if test="#request.page.hasPrePage">
								<span class="btn btn-default"><a href="umessagelist?currentPage=1">首页</a>
								</span>
								<span class="btn btn-default"><a
									href="umessagelist?currentPage=${page.currentPage -1 }">上一页</a>
								</span>
							</s:if>
							<s:else>
							...
							<s:if test="#request.page.hasNextPage">
								<span class="btn btn-default"><a
									href="umessagelist?currentPage=${page.currentPage + 1 }">下一页</a>
								</span>
								<span class="btn btn-default"><a
									href="umessagelist?currentPage=${page.totalPage }">尾页</a>
								</span>
							</s:if>
							<s:else>
