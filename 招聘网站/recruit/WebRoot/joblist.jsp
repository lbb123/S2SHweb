						...
						<div class="col-lg-12">
							<div class="panel panel-default">
								...
								<div class="bootstrap-admin-panel-content">
									...
									<br>
									<span class="btn btn-default"> 当前第 <s:property
											value="#request.page.currentPage" /> 页，共 <s:property
											value="#request.page.totalPage" /> 页 </span>
									<s:if test="#request.page.hasPrePage">
										<span class="btn btn-default"><a
											href="findjoblist?currentPage=1">首页</a> </span>
										<span class="btn btn-default"><a
											href="findjoblist?currentPage=${page.currentPage -1 }">上一页</a>
										</span>
									</s:if>
									<s:else>
									...
									<s:if test="#request.page.hasNextPage">
										<span class="btn btn-default"><a
											href="findjoblist?currentPage=${page.currentPage + 1 }">下一页</a>
										</span>
										<span class="btn btn-default"><a
											href="findjoblist?currentPage=${page.totalPage }">尾页</a> </span>
									</s:if>
									<s:else>
