					...
					<div class="panel panel-default" style="height: 410">
						<div class="panel-heading">
							<div class="text-muted bootstrap-admin-box-title">
								<a href="admin/goodsadd.jsp">新增鲜花信息</a>
							</div>
						</div>
						<div class="bootstrap-admin-panel-content">
										...
										<td>
											...
											<td class="actions">
												<a href="goodsToUpdate?goods.gid=${s.gid}">
													...
													<a href="goodsTodetail?goods.gid=${s.gid}">
							...
							<s:if test="#request.page.hasPrePage">
								<span class="btn btn-default"><a
									href="goodslist?currentPage=1">首页</a> </span>
								<span class="btn btn-default"><a
									href="goodslist?currentPage=${page.currentPage -1 }">上一页</a> </span>
							</s:if>
							<s:else>
							...
							<s:if test="#request.page.hasNextPage">
								<span class="btn btn-default"><a
									href="goodslist?currentPage=${page.currentPage + 1 }">下一页</a> </span>
								<span class="btn btn-default"><a
									href="goodslist?currentPage=${page.totalPage }">尾页</a> </span>
							</s:if>
							<s:else>
